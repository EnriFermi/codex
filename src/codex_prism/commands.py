...
COMMANDS = (
    ...
    Command("/permissions", "/permissions", "Choose file/network access and approvals"),
    Command("/approvals", "/approvals", "Permissions chooser (alias of /permissions)"),
    Command("/model", "/model", "Choose a model and reasoning effort"),
    Command("/status", "/status", "Show current conversation settings and token usage"),
